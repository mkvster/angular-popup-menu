...
gulp.task('scripts', ['clean'], function() {
  ...
  var buildTemplates = function () {
    return gulp.src('src/**/*.html')
      ...
      .pipe($.angularTemplatecache({module: 'angular.popup.menu'}));
  };
  ...
  var buildLib = function(){
    return gulp.src(['src/common.js','src/*.js'])
      ...
      .pipe($.concat('angular-popup-menu-without-templates.js'))
  ...
  return streamqueue({objectMode: true }, buildLib(), buildTemplates())
    ...
    .pipe($.concat('angular-popup-menu.js'))
    ...
    .pipe($.concat('angular-popup-menu.min.js'))
...
gulp.task('styles', ['clean'], function() {
  ...
  return gulp.src(['src/common.css'], {base: 'src'})
    ...
    .pipe($.concat('angular-popup-menu.css'))
    .pipe(gulp.dest('dist'))
    .pipe($.minifyCss())
    .pipe($.concat('angular-popup-menu.min.css'))
